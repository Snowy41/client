...
public class Setting {
    ...
    public Setting(String name, String displayName, Mod parent, String sval, ArrayList<String> options) {
        this.name = name;
    ...
    public Setting(String name, String displayName, Mod parent, boolean bval) {
        this.name = name;
        this.displayName = displayName;
    ...
    public Setting(String name, String displayName, Mod parent, double dval, double min, double max,
                   boolean onlyint) {
        this.name = name;
        this.displayName = displayName;
        this.parent = parent;
